...
[![Linting](https://github.com/melmorabity/trivy-plugin-epss/actions/workflows/linting.yml/badge.svg)](https://github.com/melmorabity/trivy-plugin-epss/actions/workflows/linting.yml) [![Unit tests](https://github.com/melmorabity/trivy-plugin-epss/actions/workflows/unit_tests.yml/badge.svg)](https://github.com/melmorabity/trivy-plugin-epss/actions/workflows/unit_tests.yml) [![codecov](https://codecov.io/gh/melmorabity/trivy-plugin-epss/branch/main/graph/badge.svg)](https://codecov.io/gh/melmorabity/trivy-plugin-epss)
...
```console
trivy plugin install github.com/melmorabity/trivy-plugin-epss@1.0.0
```
